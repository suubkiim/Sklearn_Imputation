"""Imputation module for numeric dataset. 

* Sample Usage
python imputation.py --data_path='./dataset/ecg_mitbih_test.csv' \
                     --option='simple' \
                     --strategy='mean' \
                     --output_path='./dataset/ecg_mitbih_test_imputed.csv'
...
* Testing Module with Random Noise
python imputation.py --data_path='./dataset/ecg_mitbih_test.csv' \
                     --option='simple' \
                     --strategy='mean' \
                     --output_path='./dataset/ecg_mitbih_test_imputed.csv' \
...
def main(args):
    ...
    if args.test_module:
        ...
        dataImputer.dataset.to_csv('./dataset/na_dataset.csv', mode='w', index=False, header=False)
